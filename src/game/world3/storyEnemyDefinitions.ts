...
const ENEMIES: Omit<StoryEnemyDefinition, 'level' | 'textureKey'>[] = [
  ...
  { enemyName: 'Sirius Light Raider', themeId: 'sirius', appearanceId: 'siriusRaider', health: 4, bodyDamage: 8, points: 80, hitRadius: 12, behavior: 'lateralLaser', spawnIntervalMs: 3400, maxOnScreen: 3, moveSpeed: 50, fireCooldownMs: 2700, spreadDeg: 14, shotCount: 2 },
